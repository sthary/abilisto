...
<script>
    tailwind.config={darkMode:"class",theme:{extend:{colors:{fin:"#0EA5E9",equity:"#10B981",danger:"#F43F5E",expense:"#F59E0B",hr:"#8B5CF6"},fontFamily:{display:["Syne","sans-serif"],body:["DM Sans","sans-serif"]}}}};
...
<style>
    body{font-family:'DM Sans',sans-serif;background:#F0F4FF;} .dark body{background:#0B0F1A;}
