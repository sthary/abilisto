...
<style>
    ...
    .fin-table thead th{font-family:'Syne',sans-serif;font-size:10px;letter-spacing:.08em;text-transform:uppercase;color:#94a3b8;padding:10px 12px;border-bottom:1px solid rgba(0,0,0,0.06);white-space:nowrap;}
