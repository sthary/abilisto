...
<head>
    ...
    <style>
        ...
        /* Magnifying glass that follows the cursor over the map — a real
           SVG icon (proper circle + handle in one cohesive shape) rather
           than a border-circle-plus-rotated-bar approximation, which
        ...
        .auth-magnifier {
            ...
            /* Shifts so the lens circle's center (not the icon's whole
               bounding box, which is skewed toward the handle) lands on
               the cursor. */
